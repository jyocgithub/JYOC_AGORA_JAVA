package ComunicacionEntreProcesos_Hijo;

import java.io.BufferedReader;
import java.io.InputStream;
import java.io.InputStreamReader;

class ComunicacionEntreProcesos_Hijo {
	...
	public static void main(String[] args) {
		...
		// Si se ejecuta en un IDE como Eclipse, lee normalmente de teclado (su entada estandar)
		// y escribe en consola (su salida estandar)
		// Sin embargo, si se ejecuta como hijo de otro proceso,
		// y este apunta a sus entradas estandar y salidas estandar,
		...
		// Creo variables para la logica del programa (contar palabras, letras y líneas)
		String linea;
		...
		try {
			...
			// Tras leer las lineas, envio resultados a la salida estandar (CONSOLA O PROCESO O LO QUE SEA)
