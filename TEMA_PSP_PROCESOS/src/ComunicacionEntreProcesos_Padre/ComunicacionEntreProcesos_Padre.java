package ComunicacionEntreProcesos_Padre;
...
public class ComunicacionEntreProcesos_Padre {
	public static void main (String args[]) {
		try {
			...
			// que quiero crear, En este caso, es el jar ejecutable que se ha explicado anteriormente
			...
			// -------------- CREAR UN CANAL PARA LEER LO QUE ENVIE EL PROCESO HIJO. Lo hago en dos pasos;
			...
			// ------------- CREAR UN CANAL PARA ENVIAR COSAS (ESCRIBIR) HACIA EL PROCESO HIJO, en dos pasos;
			...
			String lineaLeidaPorTeclado = maquinaLeerDeEstandar.readLine ();
			...
			while (!lineaLeidaPorTeclado.equals ("FIN") && lineaLeidaPorTeclado != null) {
				...
				lineaLeidaPorTeclado = maquinaLeerDeEstandar.readLine ();
			}
