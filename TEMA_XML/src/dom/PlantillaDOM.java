...
public class PlantillaDOM {
    ...
    public static void crearFicheroXML(ArrayList<Alumno> alumnos) {
        try {
            ...
            // - Asi se crea el objeto document Y ADEMAS le añade el elemento raiz (el padre unico)
            Document miDocumentDom;
    ...
    static Element crearElemento(String dato, String valor, Element nodopadre, Document document) {
    ...
    static void crearAtributo(String dato, String valor, Element nodopadre) {
    ...
    public static ArrayList<Alumno> leerFicheroXML() {
        ...
        try {
            DocumentBuilderFactory builderFactory = DocumentBuilderFactory.newInstance();
            DocumentBuilder builder = builderFactory.newDocumentBuilder();
            miDocDom = builder.parse(new FileInputStream(nombreFicheroXml));
        } catch (Exception e1) {
            e1.printStackTrace();
        }
        ...
        elementoRaiz = miDocDom.getDocumentElement();
        ...
        for (int t = 0; t < listaHijosRaiz.getLength(); t++) {
            ...
            nombre = getElemento("nombre", elementoAlumno);
            apellido = getElemento("apellidos", elementoAlumno);
            curso = getElemento("curso", elementoAlumno);
            sexo = getElemento("sexo", elementoAlumno).charAt(0); // para convertie el String en char
    ...
    public static String getElemento(String etiquetaABuscar, Element elementoPadre) {
