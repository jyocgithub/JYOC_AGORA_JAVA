...
/**
 * Clase ServerUDP Contiene métodos para gestionar la recepción de mensajes
 * desde un cliente y responder al mismo
 *
...
public class ServerUDP extends JFrame {
	...
	/**
	 * ServerUDP Constructor Crea la interfaz para la comunicacion de el envio y
	...
	/**
	 * method recibirYenviarMensaje() Gestiona los metodos necesarios para
	 * recibir mensajes y procesa el envio de respuesta
	 *
	 * @param Ninguno.
	 * @return Ninguno.
	 */
	public static void recibiryYenviarDatos() {
		try {
			// Crear objetos para recepcion de mensajes
