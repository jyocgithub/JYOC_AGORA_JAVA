...
/**
 * Capitulo 4 Ejercicio e_07
 * Realizar un programa para gestionar los resultados de los partidos políticos en las elecciones, que:
 * Pida los nombres de los partidos (10 como máximo ) que se han presentado a las elecciones
 * Pida los votos que ha obtenido cada partido
 * Pida el número de escaños que se reparten los partidos.
 * Utilice la ley de D´Hondt para calcular el número de escaños que obtiene cada partido
 * Muestre los escaños obtenidos por cada partido
 */
public class Jyoc_Ejercicio_4_e_07 {
